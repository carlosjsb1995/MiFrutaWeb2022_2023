...
los alamacena en la variable general y llama a la función obtenerTerrenosUsuario para obtener mas datos.
*/
function obtenerTratamientos(user){

$.post('phpTratamientos/obtenerTratamientosUsuario.php',{
  ...
  function(datos,estado){
      ...
      arrayTratamientos = jsonTerrenos;
      usuario = user;
      obtenerTerrenosUsuario(user);
      
  } );
}

/*
Nombre:obtenerTerrenosUsuario
Valores de entrada: user
Valores de salida: Ninguno
...
*/
function obtenerTerrenosUsuario(user){
...
$.post('phpTerrenos/obtenerTerrenosUsuario.php',{
  ...
  usuario : user
    ...
    function(datos,estado){
        ...
        jsonTerrenos = JSON.parse(terrenos);
        crearHTMLTratamientos(user, jsonTerrenos);
...
Valores de entrada: user,jsonTerrenos
Valores de salida: Ninguno
...
*/
function crearHTMLTratamientos(user,jsonTerrenos){
...
<div class ="row marginz">
  ...
  jsonTerrenos.forEach(elementvar => {

...
<body style="background: #f3f3f3;">
    ...
    <nav class=" marginz navbar navbar-expand-md navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="nav-content">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                <a class="nav-link" href="#" onclick="cargarEntradas('<?php echo $user; ?>')">Entradas</a>
                </li>

                <li class="nav-item">
                <a class="nav-link" href="#" onclick="obtenerAlmacen('<?php echo $user; ?>')" >Almacen</a>
                </li>

                <li class="nav-item">
                <a class="nav-link" href="#" onclick="obtenerTratamientos('<?php echo $user; ?>')" >Tratamientos</a>
                </li>

                <li class="nav-item">
                <a class="nav-link" href="#" onclick="obtenerDatosTerrenos('<?php echo $user; ?>')">Terrenos</a>
                </li>
    ...
    <div class="modal fade" id="editarUsuarioModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div id="ModalEditarTratamiento" class="modal-content">
            </div>
        </div>
    </div>

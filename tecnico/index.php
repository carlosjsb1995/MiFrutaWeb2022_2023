...
//echo $rol.'</br>';
        ...
        /*    $mysqli = new mysqli('localhost', 'root', '', 'mifruta');
            ...
            while($f = $res->fetch_object()){
                ...
                $tratamientos[] = array("id"=>$f->id,"agricultor"=>$f->agricultor,"localizacion"=>$f->localizacion,"fecha"=> $f->fecha,
...
<body style="background: #f3f3f3;">
    ...
    <nav class=" marginz navbar navbar-expand-md navbar-dark bg-dark ">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="nav-content">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick='obtenerDatosVariedades()'>Variedades</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick='obtenerDatosTerrenos()'>Terrenos</a>
                </li>
                <li class="nav-item">
    ...
    <div class="modal fade" id="añadirModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div id="modalAñadir" class="modal-content">
            </div>
        </div>
    </div>
